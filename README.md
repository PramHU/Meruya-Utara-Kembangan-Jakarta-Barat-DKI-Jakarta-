      ...
      Gambar
        ...
        <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
          ...
          <div class="carousel-inner">
				...
				<img class="d-block w-100" src="SAC 1.png" alt="First slide">
            </div>
                      </div>
          <a class="carousel-control-prev" href="SAC 2.png" role="button" data-slide="prev">
            <span class="carousel-control-custom-icon" aria-hidden="true">
              <i class="fas fa-chevron-left"></i>
            </span>
            <span class="sr-only">Previous</span>
          </a>
          <a class="carousel-control-next" href="SAC 3.png" role="button" data-slide="next">
            <span class="carousel-control-custom-icon" aria-hidden="true">
        ...
        <table class="table table-bordered">
          <thead>
			 <tr>
              <td> Lokasi  </td>
              <td>:</td>
              <td>Komplek Pertokoan Taman Meruya Blok M No. 12 Rt 004 Rw 002, Kelurahan Meruya Utara, Kecamatan Kembangan, Kotamadya Jakarta Barat, Provinsi DKI Jakarta.</tr>
			 <tr>
              <td>Basis Nilai</td>
              <td>: </td>
			...
			<tr>
              ...
              <td>:</td>
              <td><a href="https://www.google.com/maps/place/6%C2%B011'32.0%22S+106%C2%B044'23.8%22E/@-6.1922087,106.7373671,17z/data=!3m1!4b1!4m4!3m3!8m2!3d-6.192214!4d106.739942?entry=ttu">
         -6.192214, 106.739942  											
                  </a></td>
            </tr>
			<tr>
        ...
        <table class="table table-bordered">
          ...
          <tbody>
			<tr>
              <td> Lokasi  </td>
              <td>:</td>
              <td> Komplek Pertokoan Taman Meruya Blok M No. 79 </td>
            </tr>
			<tr>
              <td>Titik Koordinat</td>
              <td>:</td>
              <td><a href="https://www.google.com/maps/place/6%C2%B011'33.0%22S+106%C2%B044'23.6%22E/@-6.1925067,106.7373031,17z/data=!3m1!4b1!4m4!3m3!8m2!3d-6.192512!4d106.739878?entry=ttu">
          -6.192512, 106.739878 	 									
                  </a></td>
            </tr>
			<tr>
        ...
        <table class="table table-bordered">
          <tbody>
			<tr>
              <td> Lokasi  </td>
              <td>:</td>
              <td> Komplek Pertokoan Taman Meruya Blok M No. 9 </td>
            </tr>
			<tr>
              <td>Titik Koordinat</td>
              <td>:</td>
              <td><a href="https://www.google.com/maps/place/6%C2%B011'31.5%22S+106%C2%B044'24.5%22E/@-6.1920647,106.7375691,17z/data=!3m1!4b1!4m4!3m3!8m2!3d-6.19207!4d106.740144?entry=ttu">
          -6.192070, 106.740144 					 										
                  </a></td>
            </tr>
			<tr>
        ...
        <table class="table table-bordered">
         <tbody>
			<tr>
              <td> Lokasi  </td>
              <td>:</td>
              <td> Komplek Pertokoan Taman Meruya Blok M </td>
            </tr>
			<tr>
              <td>Titik Koordinat</td>
              <td>:</td>
